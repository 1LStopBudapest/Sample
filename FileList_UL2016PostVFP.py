...
MC_dir = "PostProcessedNtuple/2016/UL/PostVFP/MetSingleLep"
Data_dir = MC_dir
Signal_dir = MC_dir
...
samples['T2tt_Displaced_300_290'] = [os.path.join(userpath, FullSimSignal_dir, "Displaced/SMS_T2tt_LL_mStop_300_mLSP_290/"), ]
samples['T2tt_Displaced_350_335'] = [os.path.join(userpath, FullSimSignal_dir, "Displaced/SMS_T2tt_LL_mStop_350_mLSP_335/"), ]
samples['T2tt_Displaced_400_380'] = [os.path.join(userpath, FullSimSignal_dir, "Displaced/SMS_T2tt_LL_mStop_400_mLSP_380/"), ]

samples['T2tt_Prompt_500_420'] = [os.path.join(userpath, FullSimSignal_dir, "Prompt/SMS_T2tt_mStop_500_mLSP_420/"), ]
samples['T2tt_Prompt_500_450'] = [os.path.join(userpath, FullSimSignal_dir, "Prompt/SMS_T2tt_mStop_500_mLSP_450/"), ]
samples['T2tt_Prompt_500_470'] = [os.path.join(userpath, FullSimSignal_dir, "Prompt/SMS_T2tt_mStop_500_mLSP_470/"), ]
...
samples['QCD'] = [samples['QCD_HT50to100'],samples['QCD_HT100to200'],samples['QCD_HT200to300'],samples['QCD_HT200to300_madgraph'],samples['QCD_HT300to500_madgraph'],samples['QCD_HT500to700_madgraph'],samples['QCD_HT1000to1500'],samples['QCD_HT1500to2000'],samples['QCD_HT2000toInf'],samples['QCD_HT2000toInf_madgraph'] ]
...
samples['DYJetsToNuNu_HT100to200'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT100to200/"), 147.4*1.23, 799712]
samples['DYJetsToNuNu_HT200to400'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT200to400/"), 40.99*1.23, 1553972]
#samples['DYJetsToNuNu_HT400to600'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT400to600/"), 5.678*1.23, ]
samples['DYJetsToNuNu_HT600to800'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT600to800/"), 1.367*1.23, 773894]
#samples['DYJetsToNuNu_HT800to1200'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT800to1200/"), 0.6304*1.23, ]
samples['DYJetsToNuNu_HT1200to2500'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT1200to2500/"), 0.1514*1.23, 64322]
samples['DYJetsToNuNu_HT2500toInf'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT2500toInf/"), 0.003565*1.23, 78157]
samples['DYJetsToLL'] = [samples['DYJetsToNuNu_HT100to200'], samples['DYJetsToNuNu_HT200to400'],  samples['DYJetsToNuNu_HT600to800'], samples['DYJetsToNuNu_HT1200to2500'], samples['DYJetsToNuNu_HT2500toInf']]
...
samples['VV'] = [samples['WWTo2L2Nu'], samples['WZTo3LNu'], samples['ZZTo2L2Nu']]
