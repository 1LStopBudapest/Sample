...
class SampleChainSplittedBothBR():
    ...
    def get2chain(self):
        ...
        filelist03 = []
        filelist10 = []
        filelist03 = self.getfilelist(self.samplelist[self.sample][0]+"BR_0.300/")
        filelist10 = self.getfilelist(self.samplelist[self.sample][0]+"BR_1.000/")
        self.addtochain(ch03, filelist03, self.startfile, self.filestorun)
        self.addtochain(ch10, filelist10, self.startfile, self.filestorun)

        return ch03, ch10
    
    def get2chain_simple(self):
        ch03 = ROOT.TChain(self.treename)
        ch10 = ROOT.TChain(self.treename)
        file03 = self.samplelist[self.sample+"_0.3"][0]
        file10 = self.samplelist[self.sample+"_1.0"][0]
        ch03.Add(file03)
        ch10.Add(file10)
