...
# UL16 samples
# PreVFP era
samples['UL16PreVFP_TTSingleLep_pow'] = [os.path.join(userpath, UL16PreVFP_dir, "TTSingleLep_pow_CP5/"), 831.762*(3*0.108)*(1-3*0.108)*2, 2678436]
samples['UL16PreVFP_TTLep_pow'] = [os.path.join(userpath, UL16PreVFP_dir, "TTLep_pow_CP5/"), 831.762*((3*0.108)**2), 23248235]

samples['UL16PreVFP_T_tch_pow'] = [os.path.join(userpath, UL16PreVFP_dir, "T_tch_pow/"), 136.02, ]
samples['UL16PreVFP_TBar_tch_pow'] = [os.path.join(userpath, UL16PreVFP_dir, "TBar_tch_pow/"), 80.95, ]
samples['UL16PreVFP_T_tWch_ext'] = [os.path.join(userpath, UL16PreVFP_dir, "T_tWch_ext/"), 35.85, ]
samples['UL16PreVFP_TBar_tWch_ext'] = [os.path.join(userpath, UL16PreVFP_dir, "TBar_tWch_ext/"), 35.85, ]
...
#!samples['UL16PreVFP_WJetsToLNu_HT70to100'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT70to100/"), 1637.13, 429894]
samples['UL16PreVFP_WJetsToLNu_HT100to200'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT100to200/"), 1627.45, 887522]
samples['UL16PreVFP_WJetsToLNu_HT200to400'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT200to400/"), 435.237, 954588]
samples['UL16PreVFP_WJetsToLNu_HT400to600'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT400to600/"), 59.1811, 544406]
samples['UL16PreVFP_WJetsToLNu_HT600to800'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT600to800/"), 14.5805, 534803]
samples['UL16PreVFP_WJetsToLNu_HT800to1200'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT800to1200/"), 6.65621, 569975]
samples['UL16PreVFP_WJetsToLNu_HT1200to2500'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT1200to2500/"), 1.60809, 105922]
samples['UL16PreVFP_WJetsToLNu_HT2500toInf'] = [os.path.join(userpath, UL16PreVFP_dir, "WJetsToLNu_HT2500toInf/"), 0.0389136, 135533]
...
samples['UL16PreVFP_QCD_HT100to200'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT100to200/"), 27850000.0, ]
...
samples['UL16PreVFP_QCD_HT500to700'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT500to700/"), 31630, ]
samples['UL16PreVFP_QCD_HT700to1000_madgraph'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT700to1000_madgraph/"), 6802, ]
samples['UL16PreVFP_QCD_HT1000to1500'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT1000to1500/"), 1206, ]
samples['UL16PreVFP_QCD_HT1000to1500_madgraph'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT1000to1500_madgraph/"), 1206, ]
samples['UL16PreVFP_QCD_HT1500to2000'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT1500to2000/"), 20.4, ]
samples['UL16PreVFP_QCD_HT1500to2000_madgraph'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT1500to2000_madgraph/"), 20.4, ]
samples['UL16PreVFP_QCD_HT2000toInf'] = [os.path.join(userpath, UL16PreVFP_dir, "QCD_HT2000toInf/"), 25.25]
...
samples['UL16PreVFP_DYJetsToLL_M50_HT70to100'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT70to100/"), 147.4*1.23, ]
samples['UL16PreVFP_DYJetsToLL_M50_HT100to200'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT100to200/"), 147.4*1.23, ]
samples['UL16PreVFP_DYJetsToLL_M50_HT200to400'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT200to400/"), 40.99*1.23, ]
#!samples['UL16PreVFP_DYJetsToLL_M50_HT400to600'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT400to600/"), 5.678*1.23, ]
samples['UL16PreVFP_DYJetsToLL_M50_HT600to800'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT600to800/"), 1.367*1.23, ]
samples['UL16PreVFP_DYJetsToLL_M50_HT800to1200'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT800to1200/"), 0.6304*1.23, ]
...
samples['UL16PreVFP_DYJetsToLL_M50_HT2500toInf'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToLL_M50_HT2500toInf/"), 0.003565*1.23, ]
...
samples['UL16PreVFP_DYJetsToNuNu_HT100to200'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT100to200/"), 147.4*1.23, ]
samples['UL16PreVFP_DYJetsToNuNu_HT200to400'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT200to400/"), 40.99*1.23, ]
samples['UL16PreVFP_DYJetsToNuNu_HT400to600'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT400to600/"), 5.678*1.23, ]
samples['UL16PreVFP_DYJetsToNuNu_HT600to800'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT600to800/"), 1.367*1.23, ]
samples['UL16PreVFP_DYJetsToNuNu_HT800to1200'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT800to1200/"), 0.6304*1.23, ]
samples['UL16PreVFP_DYJetsToNuNu_HT1200to2500'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT1200to2500/"), 0.1514*1.23, ]
samples['UL16PreVFP_DYJetsToNuNu_HT2500toInf'] = [os.path.join(userpath, UL16PreVFP_dir, "DYJetsToNuNu_HT2500toInf/"), 0.003565*1.23, ]
...
samples['UL16PreVFP_TTWToLNu'] = [os.path.join(userpath, UL16PreVFP_dir, "TTWToLNu_CP5/"), 0.2043, ]
...
samples['UL16PreVFP_WWTo2L2Nu'] = [os.path.join(userpath, UL16PreVFP_dir, "WWTo2L2Nu/"), 12.178, ]
...
samples['UL16PreVFP_ZZTo2L2Nu'] = [os.path.join(userpath, UL16PreVFP_dir, "ZZTo2L2Nu/"), 0.564, ]
...
#Data
#MET
samples['UL16PreVFP_MET_Run2016B'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016B_ver2_HIPM_UL/"), 1.00, 5023831]
samples['UL16PreVFP_MET_Run2016C'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016C_HIPM_UL/"), 1.00, 2389671]
samples['UL16PreVFP_MET_Run2016D'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016D_HIPM_UL/"), 1.00, 3633132]
samples['UL16PreVFP_MET_Run2016E'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016E_HIPM_UL/"), 1.00, 3631331]
samples['UL16PreVFP_MET_Run2016F'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016F_HIPM_UL/"), 1.00, 2335934]
#samples['UL16PreVFP_MET_Run2016G'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016G_HIPM_UL/"), 1.00, 5150593]
#samples['UL16PreVFP_MET_Run2016H'] = [os.path.join(userpath, UL16PreVFP_dir, "MET_Run2016H_HIPM_UL/"), 1.00, 6358426]
...
# PostVFP era
samples['UL16PostVFP_TTSingleLep_pow'] = [os.path.join(userpath, UL16PostVFP_dir, "TTSingleLep_pow_CP5/"), 831.762*(3*0.108)*(1-3*0.108)*2, 2678436]
samples['UL16PostVFP_TTLep_pow'] = [os.path.join(userpath, UL16PostVFP_dir, "TTLep_pow_CP5/"), 831.762*((3*0.108)**2), 23248235]

samples['UL16PostVFP_T_tch_pow'] = [os.path.join(userpath, UL16PostVFP_dir, "T_tch_pow/"), 136.02, ]
samples['UL16PostVFP_TBar_tch_pow'] = [os.path.join(userpath, UL16PostVFP_dir, "TBar_tch_pow/"), 80.95, ]
samples['UL16PostVFP_T_tWch_ext'] = [os.path.join(userpath, UL16PostVFP_dir, "T_tWch_ext/"), 35.85, ]
samples['UL16PostVFP_TBar_tWch_ext'] = [os.path.join(userpath, UL16PostVFP_dir, "TBar_tWch_ext/"), 35.85, ]
...
samples['UL16PostVFP_WJetsToLNu_HT70to100'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT70to100/"), 1637.13, 429894]
samples['UL16PostVFP_WJetsToLNu_HT100to200'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT100to200/"), 1627.45, 887522]
samples['UL16PostVFP_WJetsToLNu_HT200to400'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT200to400/"), 435.237, 954588]
samples['UL16PostVFP_WJetsToLNu_HT400to600'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT400to600/"), 59.1811, 544406]
samples['UL16PostVFP_WJetsToLNu_HT600to800'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT600to800/"), 14.5805, 534803]
samples['UL16PostVFP_WJetsToLNu_HT800to1200'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT800to1200/"), 6.65621, 569975]
samples['UL16PostVFP_WJetsToLNu_HT1200to2500'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT1200to2500/"), 1.60809, 105922]
samples['UL16PostVFP_WJetsToLNu_HT2500toInf'] = [os.path.join(userpath, UL16PostVFP_dir, "WJetsToLNu_HT2500toInf/"), 0.0389136, 135533]
...
samples['UL16PostVFP_QCD_HT50to100'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT50to100/"), 246400000.0, ]
samples['UL16PostVFP_QCD_HT100to200'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT100to200/"), 27850000.0, ]
samples['UL16PostVFP_QCD_HT200to300'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT200to300/"), 1717000, ]
samples['UL16PostVFP_QCD_HT200to300_madgraph'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT200to300_madgraph/"), 1717000, ]
samples['UL16PostVFP_QCD_HT300to500_madgraph'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT300to500_madgraph/"), 351300, ]
samples['UL16PostVFP_QCD_HT500to700_madgraph'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT500to700_madgraph/"), 31630, ]
#!samples['UL16PostVFP_QCD_HT700to1000_madgraph'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT700to1000_madgraph/"), 6802, ]
samples['UL16PostVFP_QCD_HT1000to1500'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT1000to1500/"), 1206, ]
samples['UL16PostVFP_QCD_HT1500to2000'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT1500to2000/"), 20.4, ]
samples['UL16PostVFP_QCD_HT2000toInf'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT2000toInf/"), 25.25]
samples['UL16PostVFP_QCD_HT2000toInf_madgraph'] = [os.path.join(userpath, UL16PostVFP_dir, "QCD_HT2000toInf_madgraph/"), 25.25]
...
samples['UL16PostVFP_DYJetsToLL_M50_HT70to100'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT70to100/"), 147.4*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT100to200'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT100to200/"), 147.4*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT200to400'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT200to400/"), 40.99*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT400to600'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT400to600/"), 5.678*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT600to800'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT600to800/"), 1.367*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT800to1200'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT800to1200/"), 0.6304*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT1200to2500'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT1200to2500/"), 0.1514*1.23, ]
samples['UL16PostVFP_DYJetsToLL_M50_HT2500toInf'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToLL_M50_HT2500toInf/"), 0.003565*1.23, ]
...
samples['UL16PostVFP_DYJetsToNuNu_HT100to200'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT100to200/"), 147.4*1.23, ]
samples['UL16PostVFP_DYJetsToNuNu_HT200to400'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT200to400/"), 40.99*1.23, ]
#samples['UL16PostVFP_DYJetsToNuNu_HT400to600'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT400to600/"), 5.678*1.23, ]
samples['UL16PostVFP_DYJetsToNuNu_HT600to800'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT600to800/"), 1.367*1.23, ]
#samples['UL16PostVFP_DYJetsToNuNu_HT800to1200'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT800to1200/"), 0.6304*1.23, ]
samples['UL16PostVFP_DYJetsToNuNu_HT1200to2500'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT1200to2500/"), 0.1514*1.23, ]
samples['UL16PostVFP_DYJetsToNuNu_HT2500toInf'] = [os.path.join(userpath, UL16PostVFP_dir, "DYJetsToNuNu_HT2500toInf/"), 0.003565*1.23, ]
...
samples['UL16PostVFP_TTWToLNu'] = [os.path.join(userpath, UL16PostVFP_dir, "TTWToLNu_CP5/"), 0.2043, ]
samples['UL16PostVFP_TTWToQQ'] = [os.path.join(userpath, UL16PostVFP_dir, "TTWToQQ/"), 0.40620, ]
...
samples['UL16PostVFP_WWTo2L2Nu'] = [os.path.join(userpath, UL16PostVFP_dir, "WWTo2L2Nu/"), 12.178, ]
...
samples['UL16PostVFP_WZTo3LNu'] = [os.path.join(userpath, UL16PostVFP_dir, "WZTo3LNu_amcatnlo/"), 4.42965, ]
samples['UL16PostVFP_ZZTo2L2Nu'] = [os.path.join(userpath, UL16PostVFP_dir, "ZZTo2L2Nu/"), 0.564, ]
...
#Data
#MET
#samples['UL16PostVFP_MET_Run2016B'] = [os.path.join(userpath, UL16PostVFP_dir, "MET_Run2016B_ver2_HIPM_UL/"), 1.00, 5023831]
#samples['UL16PostVFP_MET_Run2016C'] = [os.path.join(userpath, UL16PostVFP_dir, "MET_Run2016C_HIPM_UL/"), 1.00, 2389671]
#samples['UL16PostVFP_MET_Run2016D'] = [os.path.join(userpath, UL16PostVFP_dirr, "MET_Run2016D_HIPM_UL/"), 1.00, 3633132]
#samples['UL16PostVFP_MET_Run2016E'] = [os.path.join(userpath, UL16PostVFP_dir, "MET_Run2016E_HIPM_UL/"), 1.00, 3631331]
samples['UL16PostVFP_MET_Run2016F'] = [os.path.join(userpath, UL16PostVFP_dir, "MET_Run2016F_UL/"), 1.00, 2335934]
samples['UL16PostVFP_MET_Run2016G'] = [os.path.join(userpath, UL16PostVFP_dir, "MET_Run2016G_UL/"), 1.00, 5150593]
samples['UL16PostVFP_MET_Run2016H'] = [os.path.join(userpath, UL16PostVFP_dir, "MET_Run2016H_UL/"), 1.00, 6358426]
