...
MC_dir = "PostProcessedNtuple/2018/UL/Met"
Data_dir = MC_dir
Signal_dir = "PostProcessedNtuple/2018/UL/SignalGrid"

FullSimSignal_dir = "PostProcessedNtuple/2018/UL/FullsimSig/"
FastSimSignal_dir = "PostProcessedNtuple/2018/UL/FastsimSig/"
...
samples['WWTo1L1Nu2Q'] = [os.path.join(userpath, MC_dir, "WWTo1L1Nu2Q/"), 10.71, ]
...
samples['VV'] = [samples['WW'], samples['WWTo2L2Nu'], samples['WWTo1L1Nu2Q'], samples['WZTo1L1Nu2Q'], samples['WZTo1L3Nu'], samples['WZTo2L2Q'], samples['WZTo3LNu'], samples['ZZTo2L2Nu'], samples['ZZTo2L2Q'], samples['ZZTo2Q2Nu'], samples['ZZTo4L']]


#Data
#MET
samples['MET_Run2018A'] = [os.path.join(userpath, Data_dir, "MET_Run2018A_UL/"), 1.00, 152867]
samples['MET_Run2018B'] = [os.path.join(userpath, Data_dir, "MET_Run2018B_UL/"), 1.00, 2801321]
samples['MET_Run2018C'] = [os.path.join(userpath, Data_dir, "MET_Run2018C_UL/"), 1.00, 5337885]
samples['MET_Run2018D'] = [os.path.join(userpath, Data_dir, "MET_Run2018D_UL/"), 1.00, 5337885]
samples['MET_Data'] = [samples['MET_Run2018A'], samples['MET_Run2018B'], samples['MET_Run2018C'], samples['MET_Run2018D']]
