...
MC_dir = "PostProcessedNtuple/2017/UL/Met"
Data_dir = MC_dir
Signal_dir = "PostProcessedNtuple/2017/UL/SignalGrid"

FullSimSignal_dir = "PostProcessedNtuple/2017/UL/FullsimSig/"
FastSimSignal_dir = "PostProcessedNtuple/2017/UL/FastsimSig/"
...
samples['DYJetsToLL_M4to50_HT100to200'] = [os.path.join(userpath, MC_dir, "DYJetsToLL_M4to50_HT100to200/"), 147.4*1.23, 207937]
samples['DYJetsToLL_M4to50_HT200to400'] = [os.path.join(userpath, MC_dir, "DYJetsToLL_M4to50_HT200to400/"), 40.99*1.23, 336126]
samples['DYJetsToLL_M4to50_HT400to600'] = [os.path.join(userpath, MC_dir, "DYJetsToLL_M4to50_HT400to600/"), 5.678*1.23, 236959]
samples['DYJetsToLL_M4to50_HT600toInf'] = [os.path.join(userpath, MC_dir, "DYJetsToLL_M4to50_HT600toInf/"), 1.367*1.23, 279151]
...
samples['DYJetsToLL'] = [samples['DYJetsToLL_M4to50_HT100to200'], samples['DYJetsToLL_M4to50_HT200to400'], samples['DYJetsToLL_M4to50_HT400to600'], samples['DYJetsToLL_M4to50_HT600toInf'], samples['DYJetsToLL_M50_HT100to200'], samples['DYJetsToLL_M50_HT200to400'], samples['DYJetsToLL_M50_HT400to600'], samples['DYJetsToLL_M50_HT600to800'], samples['DYJetsToLL_M50_HT800to1200'], samples['DYJetsToLL_M50_HT1200to2500'], samples['DYJetsToLL_M50_HT2500toInf']]
...
samples['TTW_LO'] = [os.path.join(userpath, MC_dir, "TTW_LO/"), 0.5297/0.692, ]
...
samples['TTV'] = [ samples['TTWToLNu'], samples['TTWToQQ'], samples['TTW_LO'], samples['TTZ_LO'], samples['TTG']]

samples['WWTo2L2Nu'] = [os.path.join(userpath, MC_dir, "WWTo2L2Nu/"), 12.178, 255545]
samples['WWTo1L1Nu2Q'] = [os.path.join(userpath, MC_dir, "WWTo1L1Nu2Q/"), 49.997, ]
...
samples['WZTo2L2Q'] = [os.path.join(userpath, MC_dir, "WZTo2Q2L/"), 5.60, ]
...
samples['ZZTo2L2Q'] = [os.path.join(userpath, MC_dir, "ZZTo2Q2L/"), 3.28, ]
samples['ZZTo2Q2Nu'] = [os.path.join(userpath, MC_dir, "ZZTo2Nu2Q/"), 4.04, ]
samples['ZZTo4L'] = [os.path.join(userpath, MC_dir, "ZZTo4L/"), 1.256*1.1, ]
#samples['WW'] = [os.path.join(userpath, MC_dir, "WW/"), 62.175, 255545]
samples['VV'] = [samples['WWTo2L2Nu'], samples['WWTo1L1Nu2Q'], samples['WZTo1L1Nu2Q'], samples['WZTo3LNu'], samples['WZTo2L2Q'], samples['WZTo3LNu'], samples['ZZTo2L2Nu'], samples['ZZTo2L2Q'], samples['ZZTo2Q2Nu'], samples['ZZTo4L']]


#Data
#MET
samples['MET_Run2017B'] = [os.path.join(userpath, Data_dir, "MET_Run2017B_UL/"), 1.00, 152867]
samples['MET_Run2017C'] = [os.path.join(userpath, Data_dir, "MET_Run2017C_UL/"), 1.00, 2801321]
samples['MET_Run2017D'] = [os.path.join(userpath, Data_dir, "MET_Run2017D_UL/"), 1.00, 5337885]
samples['MET_Run2017E'] = [os.path.join(userpath, Data_dir, "MET_Run2017E_UL/"), 1.00, 5337885]
samples['MET_Run2017F'] = [os.path.join(userpath, Data_dir, "MET_Run2017F_UL/"), 1.00, 5337885]
samples['MET_Data'] = [samples['MET_Run2017B'], samples['MET_Run2017C'], samples['MET_Run2017D'], samples['MET_Run2017E'], samples['MET_Run2017F']]
