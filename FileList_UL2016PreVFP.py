...
# T2tt sample fastsim: same sample for bothe pre and post VFP
...
samples['QCD_HT50to100_madgraph'] = [os.path.join(userpath, MC_dir, "QCD_HT50to100_madgraph/"), 246400000.0, ]
samples['QCD_HT100to200'] = [os.path.join(userpath, MC_dir, "QCD_HT100to200/"), 27850000.0, 14097]
samples['QCD_HT100to200_madgraph'] = [os.path.join(userpath, MC_dir, "QCD_HT100to200_madgraph/"), 27850000.0, 14097]
samples['QCD_HT200to300_madgraph'] = [os.path.join(userpath, MC_dir, "QCD_HT200to300_madgraph/"), 1717000, ]
samples['QCD_HT300to500'] = [os.path.join(userpath, MC_dir, "QCD_HT300to500/"), 351300, ]
samples['QCD_HT300to500_madgraph'] = [os.path.join(userpath, MC_dir, "QCD_HT300to500_madgraph/"), 351300, ]
samples['QCD_HT500to700'] = [os.path.join(userpath, MC_dir, "QCD_HT500to700/"), 31630, 526996]
samples['QCD_HT500to700_madgraph'] = [os.path.join(userpath, MC_dir, "QCD_HT500to700_madgraph/"), 31630, 526996]
samples['QCD_HT700to1000'] = [os.path.join(userpath, MC_dir, "QCD_HT700to1000/"), 6802, 365394]
...
samples['QCD_HT2000toInf_madgraph'] = [os.path.join(userpath, MC_dir, "QCD_HT2000toInf_madgraph/"), 25.25, 1069727]
#samples['QCD_All'] = [samples['QCD_HT50to100'], samples['QCD_HT50to100_madgraph'], samples['QCD_HT100to200'], samples['QCD_HT100to200_madgraph'], samples['QCD_HT200to300_madgraph'], samples['QCD_HT300to500'], samples['QCD_HT300to500_madgraph'], samples['QCD_HT500to700'], samples['QCD_HT500to700_madgraph'], samples['QCD_HT700to1000'], samples['QCD_HT700to1000_madgraph'], samples['QCD_HT1000to1500'], samples['QCD_HT1000to1500_madgraph'], samples['QCD_HT1500to2000'], samples['QCD_HT1500to2000_madgraph'], samples['QCD_HT2000toInf'], samples['QCD_HT2000toInf_madgraph']]
samples['QCD'] = [samples['QCD_HT300to500'], samples['QCD_HT300to500_madgraph'], samples['QCD_HT500to700'], samples['QCD_HT500to700_madgraph'], samples['QCD_HT700to1000'], samples['QCD_HT700to1000_madgraph'], samples['QCD_HT1000to1500'], samples['QCD_HT1000to1500_madgraph'], samples['QCD_HT1500to2000'], samples['QCD_HT1500to2000_madgraph'], samples['QCD_HT2000toInf'], samples['QCD_HT2000toInf_madgraph']]

samples['ZJetsToNuNu_HT100to200'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT100to200/"), 147.4*1.23, 859401]
samples['ZJetsToNuNu_HT200to400'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT200to400/"), 40.99*1.23, 1694312]
samples['ZJetsToNuNu_HT400to600'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT400to600/"), 5.678*1.23, 2258288]
samples['ZJetsToNuNu_HT600to800'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT600to800/"), 1.367*1.23, 828557]
samples['ZJetsToNuNu_HT800to1200'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT800to1200/"), 0.6304*1.23, 328287]
samples['ZJetsToNuNu_HT1200to2500'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT1200to2500/"), 0.1514*1.23, 75722]
samples['ZJetsToNuNu_HT2500toInf'] = [os.path.join(userpath, MC_dir, "DYJetsToNuNu_HT2500toInf/"), 0.003565*1.23, 78302]
...
samples['DYJetsToLL'] = [samples['DYJetsToLL_M50_HT70to100'], samples['DYJetsToLL_M50_HT100to200'], samples['DYJetsToLL_M50_HT200to400'],  samples['DYJetsToLL_M50_HT400to600'], samples['DYJetsToLL_M50_HT600to800'], samples['DYJetsToLL_M50_HT800to1200'], samples['DYJetsToLL_M50_HT1200to2500'], samples['DYJetsToLL_M50_HT2500toInf']]
...
samples['TTV'] = [ samples['TTWToLNu'], samples['TTZ_LO'], samples['TTG']]
...
samples['VV'] = [samples['WW'], samples['ZZTo2L2Nu']]
